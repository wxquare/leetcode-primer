...
| 218. 天际线问题 | Hard | 线段树 | 离散化建筑边界后维护各段最大高度。 | [218. 天际线问题.cc](../../leetcode/数据结构运用/线段树/218. 天际线问题.cc) | `new` |
...
| 729. 我的日程安排表 I | Medium | 有序集合 | 在有序区间中检查相邻预订是否重叠。 | [leetcode729.cc](../../leetcode/src/leetcode729.cc) | `new` |
...
| 258. 各位相加 | Easy | 数学 | 利用数根的模 9 规律处理非零数字。 | [leetcode258.cc](../../leetcode/src/leetcode258.cc) | `new` |
...
| 2579. 统计染色单元格总数 | Medium | 数学 | 把每层新增单元格化为等差增长公式。 | [leetcode2579.cc](../../leetcode/src/leetcode2579.cc) | `new` |
...
| 213. 打家劫舍 II | Medium | 动态规划 | 拆成首尾互斥的两段线性打家劫舍，取较大值。 | [leetcode213.cc](../../leetcode/src/leetcode213.cc) | `new` |
...
| Problem | Difficulty | Pattern | Key idea | Source | Review |
| --- | --- | --- | --- | --- | --- |
| Offer 22. 层序遍历 | Easy | 广度优先搜索 | 按 FIFO 顺序入队子结点，并逐层消费队列。 | [offer22.cc](../../剑指offer/src/offer22.cc) | `new` |
