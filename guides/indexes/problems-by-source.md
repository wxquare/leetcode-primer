...
| Problem | Difficulty | Pattern | Key idea | Source |
| --- | --- | --- | --- | --- |
| 剑指 Offer 3. 从尾到头打印链表 | Easy | 链表遍历 | 遍历链表后按逆序收集值。 | [offer3_print_list_from_tail.cc](../../剑指offer/src/offer3_print_list_from_tail.cc) |
| 剑指 Offer 4. 重建二叉树 | Medium | 树递归 | 用前序根结点和中序切分递归重建子树。 | [offer4_reconstruct_binary_tree.cc](../../剑指offer/src/offer4_reconstruct_binary_tree.cc) |
| 剑指 Offer 14. 链表中倒数第 k 个结点 | Medium | 双指针 | 快慢指针保持固定间距。 | [offer14_kth_node_from_tail.cc](../../剑指offer/src/offer14_kth_node_from_tail.cc) |
| 剑指 Offer 22. 层序遍历 | Easy | 广度优先搜索 | 按 FIFO 顺序逐层处理树结点。 | [offer22_print_tree_from_top_to_bottom.cc](../../剑指offer/src/offer22_print_tree_from_top_to_bottom.cc) |
| 剑指 Offer 24. 二叉树中和为某一值的路径 | Medium | 深度优先搜索 / 回溯 | 累积根到叶路径，并在每个分支后回溯。 | [offer24_path_sum.cc](../../剑指offer/src/offer24_path_sum.cc) |
| 剑指 Offer 64. 滑动窗口最大值 | Medium | 滑动窗口 | 窗口推进时在双端队列中保留递减候选。 | [offer64_sliding_window_maximum.cc](../../剑指offer/src/offer64_sliding_window_maximum.cc) |
