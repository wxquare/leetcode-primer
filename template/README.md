...
- 本目录角色：算法学习模板和笔记目录；可编译源码统一链接到 [`../其它常见的题目/src/`](../其它常见的题目/src/)。
...
| 文档 | 用途 |
| --- | --- |
| [1-基础算法.md](1-基础算法.md) | 双指针、滑动窗口、哈希、排序、模拟、贪心和分治。 |
| [2-数据结构.md](2-数据结构.md) | 栈、队列、链表、树、Trie、并查集和区间数据结构。 |
| [3-数学.md](3-数学.md) | 数论、模运算、组合、数位、位运算、随机化和几何。 |
| [4-搜索.md](4-搜索.md) | 二分、答案二分、BFS、DFS/回溯、逆向搜索和启发式搜索。 |
| [5-动态规划.md](5-动态规划.md) | 状态定义、转移、背包和常见动态规划模型。 |
| [6-图论.md](6-图论.md) | 图的建模、遍历、最短路、连通性和图上高级算法。 |

## 跨分类专题

| 文档 | 用途 |
| --- | --- |
| [专题-区间查询与统计.md](专题-区间查询与统计.md) | 前缀和、差分、树状数组、线段树、莫队和区间统计。 |
| [专题-路径问题.md](专题-路径问题.md) | 网格、树和图上的路径建模、最优路径与方案恢复。 |
...
| [专题-区间查询与统计.md](专题-区间查询与统计.md) | 教学文档：从选型、推导到 C++17 模板，覆盖前缀和/差分、离散化、BIT、线段树、莫队和随机哈希。 |
