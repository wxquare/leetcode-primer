...
| 文档 | 用途 |
| --- | --- |
| [1-数学.md](1-数学.md) | 数论、模运算、组合、数位、位运算、随机化和几何。 |
| [2-区间查询与统计.md](2-区间查询与统计.md) | 前缀和、差分、树状数组、线段树、莫队和区间统计。 |
| [3-DP.md](3-DP.md) | 状态定义、转移、背包和常见动态规划模型。 |
| [4-图论.md](4-图论.md) | 图的建模、遍历、最短路、连通性和图上高级算法。 |
| [5-搜索.md](5-搜索.md) | 二分、答案二分、BFS、DFS/回溯、逆向搜索和启发式搜索。 |
| [6-基本算法.md](6-基本算法.md) | 双指针、滑动窗口、哈希、排序、模拟、贪心和分治。 |
| [7-数据结构.md](7-数据结构.md) | 栈、队列、链表、树、Trie、并查集和区间数据结构。 |
